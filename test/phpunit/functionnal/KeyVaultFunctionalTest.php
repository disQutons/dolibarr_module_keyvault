...
/**
 * \file    test/phpunit/KeyVaultFunctionalTest.php
 * \ingroup keyvault
 ...
 *
 * @package Testkeyvault
 */
class KeyVaultFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 173323; // TODO: autodetect?
	...
	{
		$this->url('/custom/keyvault/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('keyvault/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/keyvault/admin/about.php');
		$this->authenticate();
		return $this->assertContains('keyvault/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('keyvaultwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modKeyVault_KeyVaultTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modKeyVault_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
